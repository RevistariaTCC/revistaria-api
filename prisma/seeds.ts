...
async function main() {
  ...
  const data = [ 
    //Jujutsu Kaisen
    {
      ...
      categories: {
        connect: [
          {id: categories.filter(categorie => categorie.name === 'Mangá')[0].id }
        ]
      },
        ...
        create: [
          {
            title: 'Volume 1',
            image: 'https://m.media-amazon.com/images/I/91xUwI2UEVL._SY466_.jpg',
            synopsis: 'Esta é a Vila Oculta da Folha. Naruto é o garoto mais problemático da Academia Ninja e está sempre aprontando todas!! Seu grande sonho é se tornar um shinobi digno do título de Hokage, o mais forte e respeitado ninja da vila, e superar todos os Hokages anteriores...!! Mas um segredo em torno de seu nascimento o mantém distante tanto de seu sonho quanto das pessoas...!! Não perca mais uma chance de acompanhar a empolgante jornada de Naruto, o garoto ninja que conquistou o mundo inteiro, nesta nova edição de luxo com pôsteres, freetalks exclusivos do autor e muito mais!'
          },
          {
            title: 'Volume 2',
            image: 'https://m.media-amazon.com/images/I/81nFG+aE64L._SY466_.jpg',
            synopsis: 'Naruto, Sasuke e Sakura são testados por Kakashi-sensei!! Se passarem nessa difícil prova, eles se tornarão Genins – ninjas aprendizes! A Equipe Sete parte para assegurar a proteção de um notável construtor de pontes, o senhor Tazuna, mas sinistras sombras assassinas os espreitam!!'
          },
          {
            title: 'Volume 3',
            image: 'https://m.media-amazon.com/images/I/91H3yNMsx-L._SY466_.jpg',
            synopsis: 'Zabuza, o demônio que deveria ter sido liquidado pelo sharingan de Kakashi, está vivo! Naruto e seus companheiros, que foram ao País das Ondas escoltando Tazuna, são acometidos por uma imensa sensação de insegurança. Mas não é hora para fraquejar! Sob a supervisão de Kakashi-sensei, um intenso treinamento tem início!'
          },
          {
            title: 'Volume 4',
            image: 'https://m.media-amazon.com/images/I/91W4LvtL9fL._SY466_.jpg',
            synopsis: 'Sasuke desmaia ao proteger Naruto...!! Nesse momento, o garoto, tomado por ira e tristeza, sofre uma transformação. O que vai ser de Haku, atingido pelo punho enfurecido de Naruto...?! E que rumo tomará o combate entre Zabuza e Kakashi?! O “arco do País das Ondas” chega a um fim turbulento!!'
          },
          {
            title: 'Volume 5',
            image: 'https://m.media-amazon.com/images/I/91AvEVbeDhL._SY466_.jpg',
            synopsis: 'Indicados por Kakashi-sensei, Naruto e seus companheiros de equipe prestarão o Exame Chunin! Sasuke é desafiado para uma batalha antes mesmo de chegar ao local do exame, o que prenuncia um grande tumulto...!! Enfim começam as provas de seleção, reunindo indivíduos estranhos e poderosos...!!'
          },
          {
            title: 'Volume 6',
            image: 'https://m.media-amazon.com/images/I/91eGstF2vdL._SY466_.jpg',
            synopsis: 'Começa a segunda prova do Exame Chunin!! Enquanto Naruto e seus amigos batalham por pergaminhos numa floresta sinistra, seres desconhecidos agem secretamente nos bastidores do exame. Qual será o resultado dessa prova cruel, que coloca em jogo a vida de seus participantes...?!'
          },
          {
            title: 'Volume 7',
            image: 'https://m.media-amazon.com/images/I/91iJ57NlWBL._SY466_.jpg',
            synopsis: 'Enfrentando a ameaça do trio Otonin, Sasuke, aos poucos, descobre as propriedades do selo amaldiçoado que recebeu de Orochimaru! Enquanto isso, os monitores do Exame Chunin ficam intrigados com Gaara, um ninja de habilidades excepcionais que pode ser bem mais assustador do que aparenta...'
          },
          {
            title: 'Volume 8',
            image: 'https://m.media-amazon.com/images/I/91hzR0iq04L._SY466_.jpg',
            synopsis: 'Depois de enfrentar muitos perigos, Naruto e sua equipe chegam ao fim da segunda etapa do Exame Chunin! Antes da terceira fase começar, os examinadores decidem aplicar uma etapa preliminar e eliminatória: os candidatos vão se enfrentar em combates individuais!'
          },
        ]
      },
    },
    ...
    //Lebron
    {
      ...
      categories: {
        connect: [
          {id: categories.filter(categorie => categorie.name === 'Biografia')[0].id},
          {id: categories.filter(categorie => categorie.name === 'Administração e Negócios')[0].id},
        ]
      },
      ...
      volumes: {
        create: [
          ...
          },
          {
            ...
            image: 'https://m.media-amazon.com/images/I/81v5OmfTvEL._SY466_.jpg',
          ...
          },
          {
            ...
            image: 'https://m.media-amazon.com/images/I/71SuFTR7OIL._SY466_.jpg',
  ...
  const promises = data.map(collection => new Promise((resolve, reject) => resolve(prisma.collection.create({data: {...collection}}))))
