 ...
 await prisma.collection.createMany({
    data: [ 
      //Jujutsu Kaisen
      {
        ...
        categories: {
          connect: [
            categories.filter(categorie => categorie.name === 'Mangá')[0]
          ]
        },
      ...
      //   categories: {
      //     connect: [
      //       categories.filter(categorie => categorie.name === 'Fantasia')[0],
      //       categories.filter(categorie => categorie.name === 'Drama')[0],
      //     ]
      //   },
      ...
      //         title: 'Jogos Vorazes',
      //         image: 'https://m.media-amazon.com/images/I/71WOkspHbOL._SY466_.jpg',
      //         synopsys: "KATNISS ESCUTA OS TIROS DE CANHÃO ENQUANTO RASPA O SANGUE DO GAROTO DO DISTRITO 9. Na abertura dos Jogos Vorazes, a organização não recolhe os corpos dos combatentes caídos e dá tiros de canhão até o final. Cada tiro, um morto. Onze tiros no primeiro dia. Treze jovens restaram, entre eles, Katniss. Para quem os tiros de canhão serão no dia seguinte?...Após o fim da América do Norte, uma nova nação chamada Panem surge. Formada por doze distritos, é comandada com mão de ferro pela Capital. Uma das formas com que demonstra seu poder sobre o resto do carente país é com Jogos Vorazes, uma competição anual transmitida ao vivo pela televisão, em que um garoto e uma garota de doze a dezoito anos de cada distrito são selecionados e obrigados a lutar até a morte! Para evitar que sua irmã seja a mais nova vítima do programa, Katniss se oferece para participar em seu lugar. Vinda do empobrecido Distrito 12, ela sabe como sobreviver em um ambiente hostil. Peeta, um garoto que ajudou sua família no passado, também foi selecionado. Caso vença, terá fama e fortuna. Se perder, morre. Mas para ganhar a competição, será preciso muito mais do que habilidade. Até onde Katniss estará disposta a ir para ser vitoriosa nos Jogos Vorazes?"
      //       },
      //       {
      //         title: 'Em Chamas',
      ...
      //   categories: {
      //     connect: [
      //       categories.filter(categorie => categorie.name === 'Biografia')[0],
      //       categories.filter(categorie => categorie.name === 'Administração e Negócios')[0],
      //     ]
      //   },
      ...
      //   categories: {
      //     connect: [
      //       categories.filter(categorie => categorie.name === 'Ficção Científica')[0],
      //     ]
      //   },
